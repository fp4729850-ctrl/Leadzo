  ...
  return (
    ...
    >
      ...
      {messageVisible && statusMessage && (
        <div className="absolute bottom-[30px] left-1/2 transform -translate-x-1/2 bg-white/95 backdrop-blur-sm px-4 py-2 rounded-2xl shadow-xl border border-slate-200 text-sm font-semibold text-slate-800 whitespace-nowrap z-50 animate-in fade-in zoom-in slide-in-from-bottom-2 duration-300">
          {statusMessage}
      ...
      {/* Invisible anchor targeting the person in the background */}
      <div className="relative flex flex-col items-center">
        {/* Active Glow Indicator above the person */}
        {isSending && (
          <div className="absolute -top-4 w-4 h-4 bg-emerald-400 rounded-full animate-pulse shadow-[0_0_15px_rgba(52,211,113,0.8)] z-10"></div>
        )}
        
        {/* Name Tag pointing to the person in the background image */}
