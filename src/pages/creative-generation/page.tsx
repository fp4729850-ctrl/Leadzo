...
export default function CreativeGenerationPage() {
  return (
    <>
      ...
      <Unauthenticated><div className="flex flex-col items-center justify-center h-64 gap-4"><p className="text-muted-foreground text-sm">Sign in to use Creative Generation Agent</p><SignInButton /></div></Unauthenticated>
      <Authenticated><CreativeGenerationInner /></Authenticated>
    </>
  );
}
